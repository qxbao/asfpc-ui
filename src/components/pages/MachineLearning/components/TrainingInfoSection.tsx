...
export default function TrainingInfoSection({ metadata, modelName }: TrainingInfoSectionProps) {
	...
	return (
		<Box>
			...
			<Box display="flex" flexDirection="column" gap={1}>
				...
				<MetricRow
					label="Saved At"
					value={metadata.saved_at ? new Date(metadata.saved_at).toLocaleString() : "N/A"}
