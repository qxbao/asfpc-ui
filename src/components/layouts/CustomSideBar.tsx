...
import { Dashboard, BarChart, Settings, AccountBox, Assignment, DensitySmall } from "@mui/icons-material"
...
const navItems: NavChild[] = [
  ...
  { text: "Prompts", icon: <Assignment />, url: "/prompts" },
  { text: "Statistics", icon: <BarChart />, url: "/stats" },
  { text: "Logs", icon: <DensitySmall />, url: "/logs" },
